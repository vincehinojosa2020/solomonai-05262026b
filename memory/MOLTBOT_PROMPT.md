...
**Base URL:** `https://auth-fix-preview-5.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://auth-fix-preview-5.preview.emergentagent.com/api/v1/agent/visitors?days=7
