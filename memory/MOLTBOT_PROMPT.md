...
**Base URL:** `https://platform-god-mode.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://platform-god-mode.preview.emergentagent.com/api/v1/agent/visitors?days=7
