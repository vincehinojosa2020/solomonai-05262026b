...
**Base URL:** `https://church-platform-5.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://church-platform-5.preview.emergentagent.com/api/v1/agent/visitors?days=7
