...
**Base URL:** `https://exec-metrics-hub.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://exec-metrics-hub.preview.emergentagent.com/api/v1/agent/visitors?days=7
