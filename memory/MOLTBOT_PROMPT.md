...
**Base URL:** `https://solomon-voice-ai.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://solomon-voice-ai.preview.emergentagent.com/api/v1/agent/visitors?days=7
