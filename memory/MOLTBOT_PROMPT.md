...
**Base URL:** `https://church-planning.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://church-planning.preview.emergentagent.com/api/v1/agent/visitors?days=7
