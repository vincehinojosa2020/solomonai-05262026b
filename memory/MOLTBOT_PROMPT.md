...
**Base URL:** `https://secure-deploy-17.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://secure-deploy-17.preview.emergentagent.com/api/v1/agent/visitors?days=7
