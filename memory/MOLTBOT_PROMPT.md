...
**Base URL:** `https://church-crud-verified.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://church-crud-verified.preview.emergentagent.com/api/v1/agent/visitors?days=7
