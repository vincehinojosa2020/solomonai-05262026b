...
**Base URL:** `https://members-showcase.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://members-showcase.preview.emergentagent.com/api/v1/agent/visitors?days=7
