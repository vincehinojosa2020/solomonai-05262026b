...
**Base URL:** `https://phase3-preview-2.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://phase3-preview-2.preview.emergentagent.com/api/v1/agent/visitors?days=7
