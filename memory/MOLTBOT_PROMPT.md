...
**Base URL:** `https://demo-ready-saas.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://demo-ready-saas.preview.emergentagent.com/api/v1/agent/visitors?days=7
