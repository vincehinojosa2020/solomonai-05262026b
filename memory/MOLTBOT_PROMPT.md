...
**Base URL:** `https://platform-stripe-feed.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://platform-stripe-feed.preview.emergentagent.com/api/v1/agent/visitors?days=7
