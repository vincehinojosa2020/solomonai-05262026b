...
**Base URL:** `https://parity-audit-preview.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://parity-audit-preview.preview.emergentagent.com/api/v1/agent/visitors?days=7
