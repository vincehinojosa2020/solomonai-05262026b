...
**Base URL:** `https://solomonpay-ledger.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://solomonpay-ledger.preview.emergentagent.com/api/v1/agent/visitors?days=7
