...
**Base URL:** `https://sunday-school-portal.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://sunday-school-portal.preview.emergentagent.com/api/v1/agent/visitors?days=7
