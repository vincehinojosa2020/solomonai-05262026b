...
**Base URL:** `https://kids-checkin-live.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://kids-checkin-live.preview.emergentagent.com/api/v1/agent/visitors?days=7
