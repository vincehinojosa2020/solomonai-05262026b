...
**Base URL:** `https://installable-church.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://installable-church.preview.emergentagent.com/api/v1/agent/visitors?days=7
