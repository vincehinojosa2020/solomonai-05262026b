...
**Base URL:** `https://solomon-demo-mvp.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://solomon-demo-mvp.preview.emergentagent.com/api/v1/agent/visitors?days=7
