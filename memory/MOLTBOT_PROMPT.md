...
**Base URL:** `https://compliance-check-143.preview.emergentagent.com/api/v1/agent`
...
**Agent Actions:**
1. GET https://compliance-check-143.preview.emergentagent.com/api/v1/agent/visitors?days=7
