...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://church-planning.preview.emergentagent.com')
    ...
    def test_create_donation_checkout_valid(self):
        ...
        response = requests.post(
            ...
            json={
                "package_id": "tithe_50",
                "fund_id": "general",
                "origin_url": "https://church-planning.preview.emergentagent.com",
                "recurring": False,
