...
# Database, auth, permissions, and shared helpers now live in core/
from core import (
    db, client,
    DEFAULT_TENANT_ID, PLATFORM_ADMIN_EMAILS,
    ROLES, PERMISSION_REGISTRY, MEMBER_PERMISSIONS,
    ALL_ADMIN_PERMISSIONS, ALL_PLATFORM_PERMISSIONS, ROLE_TEMPLATES,
    check_rate_limit_v2, RATE_LIMITS,
    get_session_token_from_request,
    get_current_admin_user, get_current_portal_user, get_current_member_user,
    require_tenant,
    get_permissions_for_user, check_permission, require_permission,
    check_idempotency, store_idempotency,
    audit_log,
    get_tenant_by_subdomain, get_tenant_by_id, validate_tenant_subscription,
    logger,
)
...
# Rate limiting imported from core.check_rate_limit_v2
...
# check_rate_limit_v2: imported from core
...
# Multi-tenant config, permissions, audit: imported from core
# Idempotency, audit, tenant helpers: imported from core
...
# DEFAULT_TENANT_ID: imported from core
...
@api_router.post("/admin/services/templates")
...
@api_router.get("/admin/services/templates")
...
@api_router.post("/admin/services/plans/from-template")
...
@api_router.post("/admin/services/plans/{plan_id}/duplicate")
...
@api_router.post("/admin/volunteers/blockout-dates")
...
@api_router.get("/admin/volunteers/blockout-dates")
...
@api_router.delete("/admin/volunteers/blockout-dates/{blockout_id}")
...
@api_router.post("/portal/volunteer/blockout-dates")
...
@api_router.get("/music-stand/{plan_id}")
